...
// Import direto do módulo de tokens (não do barrel `@fecho/design-system`):
...
import { lightColors } from "@fecho/design-system/src/tokens/colors";

export default function App() {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Fechô</Text>
