...
## Google Calendar
- **Faz bem:** onipresença, integrações, confiabilidade, "Find a time".
- **Faz mal:** privacidade rasa (livre/ocupado apenas), zero noção de prioridade social, negociação de horário inexistente.
- **Experiência:** utilitária, neutra, sem calor humano.
...
- **Faz mal:** transacional e frio, sem contexto de relação/prioridade, sem privacidade granular por convidado.
- **Experiência:** eficiente, mas impessoal.
...
- **Faz mal:** não é um calendário de verdade, sem prioridade, sem privacidade de agenda, experiência datada.
- **Experiência:** funcional, mas fora do fluxo diário do usuário.
...
- **Faz mal:** sem prioridade, sem negociação de horário, sem descoberta de eventos, sem separação clara de privacidade por papel.
- **Experiência:** amigável, mas limitada a compartilhamento total.
- **Integrações:** básicas.
